...
- [x] **C. Batch objects** — output bucket, IAM roles, compute env, queue, 2 job defs → [03_batch_setup.md](03_batch_setup.md) *(done 2026-09-22)*
- [x] **C2. Preflight** — `pixi run -e ops python scripts/preflight.py`, which reads roles, bucket, Batch objects and image back from AWS. Exit 0 or do not submit. *(exit 0 on 2026-09-22)*
